...
class LambdaFunctions
{
    public:
        LambdaFunctions()
        {
            ...
            // When creating custom lambda functions, it's more readable to use "auto"
            // instead of using function pointer syntax
            ...
            auto defaultExample = [/*Default*/]() {
                std::cout << " Default example: Cannot capture variables outside scope" << std::endl
                          << std::endl;
            };
            defaultExample();
            ...
            auto valueCaptureListExample = [myString1, myString2]() {
                std::cout << "Captured via val capture list: " << myString1 << " " << myString2 << std::endl
                          << std::endl;
            };
            ...
            std::cout << "Captured and altered via reference capture list: " << myString1 << " " << myString2 << std::endl
                      << std::endl;
